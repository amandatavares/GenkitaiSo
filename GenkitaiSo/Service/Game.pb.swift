...
extension MoveRequest.FROM: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 3: try { try decoder.decodeSingularDoubleField(value: &self.row) }()
      case 4: try { try decoder.decodeSingularDoubleField(value: &self.column) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.row != 0 {
      try visitor.visitSingularDoubleField(value: self.row, fieldNumber: 3)
    }
    if self.column != 0 {
      try visitor.visitSingularDoubleField(value: self.column, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension MoveRequest.TO: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 5: try { try decoder.decodeSingularDoubleField(value: &self.row) }()
      case 6: try { try decoder.decodeSingularDoubleField(value: &self.column) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.row != 0 {
      try visitor.visitSingularDoubleField(value: self.row, fieldNumber: 5)
    }
    if self.column != 0 {
      try visitor.visitSingularDoubleField(value: self.column, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
